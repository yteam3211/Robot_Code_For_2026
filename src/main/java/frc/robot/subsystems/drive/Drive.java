...
import frc.robot.subsystems.vision.Vision.VisionConsumerPose2d;
...
public class Drive extends SubsystemBase implements VisionConsumerPose2d {
  ...
  private double rawPitchGyroRotaion = 0;
  private double rawRollGyroRotaion = 0;
