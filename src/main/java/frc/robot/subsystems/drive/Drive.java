...
public class Drive extends SubsystemBase implements VisionConsumer {
  ...
  public Drive(
    ...
    // setpointGenerator = new SwerveSetpointGenerator(PP_CONFIG, RadiansPerSecond.of(5.4));
  ...
  public static Drive getInsatnce(){
    if (instance == null) {
  ...
  public void periodic() {
    if (getCurrentCommand() != null) {
      Logger.recordOutput("Drive/CurrentCommand", getCurrentCommand().getName());
    }
    ...
    for (int i = 0; i < sampleCount; i++) {
      ...
      if (gyroInputs.connected) {
        ...
        rawYawGyroRotation = gyroInputs.odometryYawPositions[i];
      } else {
  ...
  public Pose2d firstPoseSysid = new Pose2d();
  /** Returns a command to run a quasistatic test in the specified direction. */
  public Command sysIdQuasistatic(SysIdRoutine.Direction direction) {
    return runOnce(()-> firstPoseSysid = getPose())
        .andThen(run(() -> runCharacterization(0.0))
        .withTimeout(1.0)
