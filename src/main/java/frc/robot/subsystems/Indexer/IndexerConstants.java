...
public class IndexerConstants {    
    ...
    public static final double gearRatio = 6.666;
    ...
    public static final InvertedValue Inverted = InvertedValue.Clockwise_Positive;
        ...
        public static final double Slot0_MOTOR_KS = 0.29879;//0.23
        public static final double Slot0_MOTOR_KA = 0.0017145;
        public static final double Slot0_MOTOR_KV = 0.8;
        public static final double Slot0_MOTOR_KG = 0;
        public static final double Slot0_MOTOR_KP = 1.544;
