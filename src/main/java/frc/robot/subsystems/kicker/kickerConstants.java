...
public class kickerConstants {
    ...
    public static final InvertedValue Inverted = InvertedValue.Clockwise_Positive;
        ...
        public static final double Slot0_MOTOR_KS = 0.5;//0.23
        public static final double Slot0_MOTOR_KA = 0;
        public static final double Slot0_MOTOR_KV = 0.27;
        public static final double Slot0_MOTOR_KG = 0;
        public static final double Slot0_MOTOR_KP = 1;
        public static final double Slot0_MOTOR_KI = 0.4;
